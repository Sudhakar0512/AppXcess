...
const EditTaskForm = ({ task, onSave, onCancel }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 bg-white rounded-lg shadow-xl border border-gray-200">
            <h2 className="text-xl sm:text-2xl font-semibold mb-4 text-gray-800">Edit Task</h2>
            <div className="mb-4">
...
const TaskList = () => {
    ...
    return (
        <div className="p-4 sm:p-10 bg-gradient-to-r from-blue-200 via-blue-300 to-blue-500 min-h-screen">
            <h1 className="text-3xl sm:text-4xl font-extrabold text-center text-gray-800 mb-6 sm:mb-8">Task List</h1>
            ...
            <div className="space-y-4">
                {editingTask ? (
                    ...
                    tasks.map((task) => (
                        <div
                            key={task._id}
                            className={`flex flex-col sm:flex-row items-center justify-between p-4 sm:p-6 bg-white rounded-lg shadow-md border border-gray-200 transition-transform transform hover:scale-102 ${
                                task.completed ? 'bg-gray-100 line-through' : ''
                            }`}
                        >
                            <div className="flex-1 mb-4 sm:mb-0">
                                <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-2">{task.title}</h2>
